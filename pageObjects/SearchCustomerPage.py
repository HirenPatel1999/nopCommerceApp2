class SearchCustomer:
    ...
    tableColumns_xpath = "(//tr[@role='row'])[1]/th "
    ...
    def searchCustomerByEmail(self,email):
        ...
        for r in range(1,self.getNoOfRows()+1):
          ...
          emailid= table.find_element_by_xpath("(//tbody/tr[1]/td/following-sibling::td)[1]").text
          if emailid == email:
              flag = True
              break
        return flag
    ...
    def searchCustomerByName(self,Name):
        ...
        for r in range(1, self.getNoOfRows()+1):
          ...
          name = table.find_elements_by_xpath("(//tbody/tr[1]/td/following-sibling::td)[2]").text
          if name == Name:
              flag = True
              break
        return flag
